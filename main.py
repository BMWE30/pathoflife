...
textures = {
    ...
    "banana": loadTexture("banana.png"),
    "choc": loadTexture("choc.png"),
    "broccoli": loadTexture("broccoli.png"),
    "pikachu": loadTexture("pikachu.png"),
...
# print("floorSeed : ", floorSeed)

# 1
# [97, 100, 119, 115, 1073741904, 1073741903, 1073741906, 1073741905, 113, 101]
# DEEFAFIC
