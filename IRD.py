...
class IRD(Enemy):
	...
	def __init__(self, textures, sounds):
		self.texture = textures["bosses"]["ird"].subsurface(0, 128, 160, 128)
		self.sounds = sounds
		self.textures = textures

		self.frames = [
			textures["bosses"]["ird"].subsurface(160, 128, 160, 128),
			textures["bosses"]["ird"].subsurface(160, 0, 160, 128),
			textures["bosses"]["ird"].subsurface(0, 0, 160, 128)
		]
